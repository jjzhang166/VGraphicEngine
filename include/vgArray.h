/**!
*声明:vgArray完全使用了Irrlicht引擎的实现*/

#ifndef __CHANGVOXEL_ARRAY_H__
#define __CHANGVOXEL_ARRAY_H__
#include "vgTypes.h"
#include "vgMath.h"
...
namespace vg
{
	namespace core
	{
		...
		*/
		template <class T, typename TAlloc = vgAllocator<T> >
		class array
		{
		...
		public:
			...
			*/
			...
			{
				_VG_DEBUG_BREAK_IF(index>used) // access violation
			...
			T& getLast()
			{
				_VG_DEBUG_BREAK_IF(!used) // access violation
