...
namespace vg
{
	namespace vr
	{
		...
		const f32 invForf32 = 1.0f / 255.0f;
		const f32 invForu32 = 255.0f;

		//! An enum for the color format of textures used by the vg Engine.
		/** A color format specifies how color information is stored. */
		enum ECOLOR_FORMAT
		{
			//! 16 bit color format used by the software driver.
			/** It is thus preferred by all other vg engine video drivers.
		...
		inline u16 RGB16BIT555(u32 r, u32 g, u32 b, u32 a = 0x1)
		{
			return ((b & 31) + ((g & 31) << 5) + ((r & 31) << 10) + ((a & 1) << 15));
		}

		//! this builds a 16 bit color value in 5.6.5 format (green dominate mode)
		//#define _RGB16BIT565(r,g,b) ((b & 31) + ((g & 63) << 5) + ((r & 31) << 11))
		inline u16 RGB16BIT565(u32 r, u32 g, u32 b)
		{
			return ((b & 31) + ((g & 63) << 5) + ((r & 31) << 11));
		}
		//! this builds a 24 bit color value in 8.8.8 format 
		//#define _RGB24BIT(a,r,g,b) ((b) + ((g) << 8) + ((r) << 16) )
		inline u32 RGB24BIT(u32 a, u32 r, u32 g, u32 b)
		{
			return ((b & 0xff) | ((g & 0xff) << 8) | ((r & 0xff) << 16));
		}
		//! this builds a 32 bit color value in A.8.8.8 format (8-bit alpha mode)
		//#define _RGB32BIT(a,r,g,b) ((b) + ((g) << 8) + ((r) << 16) + ((a) << 24))
		inline u32 RGB32BIT(u32 a, u32 r, u32 g, u32 b)
		{
		...
		inline u32 A8R8G8B8(f32 fr, f32 fg, f32 fb, f32 fa = 0xFF)
		{
			u32 r = (u32)(fr*invForu32);
			u32 g = (u32)(fg*invForu32);
			u32 b = (u32)(fb*invForu32);
			u32 a = (u32)(fa*invForu32);
			return (((a & 0xff) << 24) | ((r & 0xff) << 16) | ((g & 0xff) << 8) | (b & 0xff));
		}

		inline u32 A8R8G8B8(glm::vec4 fcolor)
		{
			u32 r = (u32)(fcolor.r*invForu32);
			u32 g = (u32)(fcolor.g*invForu32);
			u32 b = (u32)(fcolor.b*invForu32);
			u32 a = (u32)(fcolor.a*invForu32);
			return (((a & 0xff) << 24) | ((r & 0xff) << 16) | ((g & 0xff) << 8) | (b & 0xff));
		}
		...
		inline u16 A8R8G8B8toR5G5B5(u32 color)
		{
			return (u16)((0x80000000) |
				(color & 0x00F80000) >> 9 |
				(color & 0x0000F800) >> 6 |
				(color & 0x000000F8) >> 3);
		}
		...
		inline glm::vec4 A1R5G5B5Toglmvec4(u16 color)
		{
			glm::vec4 retVec4;

			retVec4.r = ((color >> 10) & 0x1F) * invForf32;
			retVec4.g = ((color >> 5) & 0x1F)* invForf32;
			retVec4.b = (color & 0x1F) * invForf32;
			retVec4.a = ((color >> 15) & 0x1)  * invForf32;
			return retVec4;
		}

		inline glm::vec4 R5G6B5Toglmvec4(u16 color)
		{
			glm::vec4 retVec4;

			retVec4.r = ((float)((color & 0xF800) << 8)) * invForf32;
			retVec4.g = ((float)((color & 0x07E0) << 5))* invForf32;
			retVec4.b = ((float)((color & 0x001F) << 3)) * invForf32;
			retVec4.a = 1.0f;

			return retVec4;
		}

		inline glm::vec4 A8R8B8G8toglmvec4(u32 color)
		{
			glm::vec4 retVec4;
			retVec4.r = (float)((color >> 16) & 0xff) * invForf32;
			retVec4.g = (float)((color >> 8) & 0xff) * invForf32;
			retVec4.b = (float)(color & 0xff) * invForf32;
			retVec4.a = (float)(color >> 24) * invForf32;
			return retVec4;
		}

		inline glm::vec4 R8B8G8toglmvec4(u32 color)
		{
			glm::vec4 retVec4;
			retVec4.r = ((color >> 16) & 0xff) * invForf32;
			retVec4.g = ((color >> 8) & 0xff) * invForf32;
			retVec4.b = (color & 0xff) * invForf32;
			retVec4.a = (color >> 24) * invForf32;
			return retVec4;
		}

		inline f32 U8toF32(u8 c)
		{
			return ((f32)c*invForf32);
		}
		...
		Alpha in vg is opacity, so 0 is fully transparent, 255 is fully opaque (solid).
		This class is used by most parts of the vg Engine
		...
		*/
		...
		public:
			...
			SColor(glm::vec4 fcolor)
			{
				color = A8R8G8B8(fcolor);
			}
			...
			{
				return 0.5f*(core::MAX(core::MAX(getRed(), getGreen()), getBlue()) + core::MIN(core::MIN(getRed(), getGreen()), getBlue()));
			}
			...
			{
				return SColor(core::MIN(getAlpha() + other.getAlpha(), 255u),
					core::MIN(getRed() + other.getRed(), 255u),
					core::MIN(getGreen() + other.getGreen(), 255u),
					core::MIN(getBlue() + other.getBlue(), 255u));
			}
		...
		*/
		...
		{
			const f32 maxVal = core::MAX(color.getRed(), color.getGreen(), color.getBlue());
			const f32 minVal = (f32)core::MIN(color.getRed(), color.getGreen(), color.getBlue());
